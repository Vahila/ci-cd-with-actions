[![React App CI](https://github.com/Vahila/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/Vahila/ci-cd-with-actions/actions/workflows/ci.yml)
